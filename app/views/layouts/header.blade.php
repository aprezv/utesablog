...
<!-- Mirrored from htmlstream.com/preview/unify-v1.6-production/page_home6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Feb 2015 04:53:21 GMT -->
<head>
    ...
    {{ HTML::style( asset('assets/css/headers/header-v4.css') ) }}
    {{ HTML::style( asset('assets/css/plugins/style-switcher.css') ) }}
            ...
            <div class="col-md-9">
                ...
                <div class="carousel slide carousel-v1 margin-bottom-40" id="myCarousel-1">
                    <div class="carousel-inner">
                        <div class="item active">
                            <img alt="" src="assets/img/posts/2.jpg">
                            <div class="carousel-caption">
                                <p>Facilisis odio, dapibus ac justo acilisis gestinas.</p>
                            </div>
                        </div>
                        <div class="item">
                            <img alt="" src="assets/img/posts/1.jpg">
                            <div class="carousel-caption">
                                <p>Cras justo odio, dapibus ac facilisis into egestas.</p>
                            </div>
                            </div>
                        <div class="item">
                            <img alt="" src="assets/img/posts/3.jpg">
                            <div class="carousel-caption">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/9.jpg" alt=""></a>
                        ...
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/10.jpg" alt=""></a>
                ...
                <div class="magazine-news">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/7.jpg" alt=""></a>
                        ...
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/11.jpg" alt=""></a>
                ...
                <div class="magazine-news">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/3.jpg" alt=""></a>
                        ...
                        <div class="col-md-6">
                            <div class="magazine-news-img">
                                <a href="#"><img class="img-responsive" src="assets/img/main/5.jpg" alt=""></a>
            ...
            <div class="col-md-3">
                ...
                <div class="row margin-bottom-40">
                    ...
                    <div class="magazine-posts col-md-12 col-sm-6">
                        ...
                        <div class="magazine-posts-img">
                            <a href="#"><img class="img-responsive" src="assets/img/main/1.jpg" alt=""></a>
...
{{ HTML::script('assets/plugins/jquery/jquery-migrate.min.js') }}
...
{{ HTML::script('assets/js/plugins/style-switcher.js') }}
...
<!-- Mirrored from htmlstream.com/preview/unify-v1.6-production/page_home6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Feb 2015 04:54:31 GMT -->
</html>