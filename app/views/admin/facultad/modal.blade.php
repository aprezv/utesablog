...
<div class="modal fade" id="modal-nuevo" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
    <div class="modal-dialog">
        <form id="form-nuevo" method="post" onsubmit="submitForm(event, $(this));">
            <input type="hidden" name="id" id="id" value="{{$f->id or ''}}">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">{{$action or 'Nueva' }} Facultad</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="name" value="{{$f->name or ''}}"  class="form-control">
                    </div>
                </div>
